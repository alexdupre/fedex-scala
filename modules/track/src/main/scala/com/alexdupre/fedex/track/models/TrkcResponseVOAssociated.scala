...
/** This is a wrapper class for outputVO
  ...
  */
case class TrkcResponseVOAssociated(
    transactionId: Option[String] = None,
    customerTransactionId: Option[String] = None,
    output: Option[BaseProcessOutputVOAssociated] = None
)

object TrkcResponseVOAssociated {

  given Encoder[TrkcResponseVOAssociated] = new Encoder.AsObject[TrkcResponseVOAssociated] {
    final def encodeObject(o: TrkcResponseVOAssociated): JsonObject = {
  ...
  given Decoder[TrkcResponseVOAssociated] = (c: HCursor) => {
    for {
      ...
      output                <- c.downField("output").as[Option[BaseProcessOutputVOAssociated]]
    } yield TrkcResponseVOAssociated(transactionId, customerTransactionId, output)
  }
}
