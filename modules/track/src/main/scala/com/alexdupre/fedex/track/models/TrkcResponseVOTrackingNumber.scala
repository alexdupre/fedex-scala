...
/** This is a wrapper class for outputVO
  ...
  */
case class TrkcResponseVOTrackingNumber(
    transactionId: Option[String] = None,
    customerTransactionId: Option[String] = None,
    output: Option[BaseProcessOutputVOTrackingNumber] = None
)

object TrkcResponseVOTrackingNumber {

  given Encoder[TrkcResponseVOTrackingNumber] = new Encoder.AsObject[TrkcResponseVOTrackingNumber] {
    final def encodeObject(o: TrkcResponseVOTrackingNumber): JsonObject = {
  ...
  given Decoder[TrkcResponseVOTrackingNumber] = (c: HCursor) => {
    for {
      ...
      output                <- c.downField("output").as[Option[BaseProcessOutputVOTrackingNumber]]
    } yield TrkcResponseVOTrackingNumber(transactionId, customerTransactionId, output)
  }
}
