...
/** Indicate the contact details of the shipper.
  ...
  * @param phoneNumber
  *   Contact person's phone number. <br>Minimum length is 10 and supports maximum of 15 for certain countries using longer phone
  ...
  *   1234567890
  * @param companyName
  *   Contact person's company name.<br>Note: Recommended Length is 35. There's no specific validation for the company name.<br>Example:
  *   FedEx
  */
case class Contact1(
...
object Contact1 {
  ...
  given Encoder[Contact1] = new Encoder.AsObject[Contact1] {
    final def encodeObject(o: Contact1): JsonObject = {
  ...
  given Decoder[Contact1] = (c: HCursor) => {
    for {
    ...
    } yield Contact1(personName, emailAddress, phoneNumber, phoneExtension, faxNumber, companyName)
  }
}
