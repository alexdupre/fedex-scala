...
/** Indicate the contact details of the shipper.
  ...
  *   1234567890
  * @param companyName
  *   Specify contact company name.<br>Recommended length is 35.<br>Note: There's no specific validation for the company name.<br>Example:
  *   FedEx
  */
case class Contact2(
...
object Contact2 {
  ...
  given Encoder[Contact2] = new Encoder.AsObject[Contact2] {
    final def encodeObject(o: Contact2): JsonObject = {
  ...
  given Decoder[Contact2] = (c: HCursor) => {
    for {
    ...
    } yield Contact2(personName, emailAddress, phoneNumber, phoneExtension, faxNumber, companyName)
  }
}
